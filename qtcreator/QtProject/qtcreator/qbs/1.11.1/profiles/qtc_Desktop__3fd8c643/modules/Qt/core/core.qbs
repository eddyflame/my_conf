...
Module {
    ...
    property string libFilePathDebug: "C:/Qt/Qt5.9.6/5.9.6/mingw53_32/lib/libQt5Cored.a"
    property string libFilePathRelease: "C:/Qt/Qt5.9.6/5.9.6/mingw53_32/lib/libQt5Core.a"
    ...
    cpp.includePaths: {
        var paths = ["C:/Qt/Qt5.9.6/5.9.6/mingw53_32/include", "C:/Qt/Qt5.9.6/5.9.6/mingw53_32/include/QtCore"];
    ...
    cpp.staticLibraries: {
        ...
        if (qbs.targetOS.contains('windows') && !product.consoleApplication) {
            libs = libs.concat(qtBuildVariant === "debug"
                               ? ["C:/Qt/Qt5.9.6/5.9.6/mingw53_32/lib/libqtmaind.a"] : ["C:/Qt/Qt5.9.6/5.9.6/mingw53_32/lib/libqtmain.a"]);
        }
