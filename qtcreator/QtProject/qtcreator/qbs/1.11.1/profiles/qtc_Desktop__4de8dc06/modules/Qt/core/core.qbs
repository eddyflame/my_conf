...
Module {
    ...
    property path docPath: "C:/Qt/Qt5.9.6/Docs/Qt-5.9.6"
    ...
    property string libFilePathDebug: "C:/Qt/Qt5.9.6/5.9.6/msvc2015_64/lib/Qt5Cored.lib"
    property string libFilePathRelease: "C:/Qt/Qt5.9.6/5.9.6/msvc2015_64/lib/Qt5Core.lib"
    ...
    cpp.includePaths: {
        var paths = ["C:/Qt/Qt5.9.6/5.9.6/msvc2015_64/include", "C:/Qt/Qt5.9.6/5.9.6/msvc2015_64/include/QtCore"];
    ...
    cpp.staticLibraries: {
        ...
        if (qbs.targetOS.contains('windows') && !product.consoleApplication) {
            libs = libs.concat(qtBuildVariant === "debug"
                               ? ["Shell32.lib", "C:/Qt/Qt5.9.6/5.9.6/msvc2015_64/lib/qtmaind.lib"] : ["Shell32.lib", "C:/Qt/Qt5.9.6/5.9.6/msvc2015_64/lib/qtmain.lib"]);
        }
